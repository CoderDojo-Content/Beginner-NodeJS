1. Before doing this card you should have completed the Javascript and HTML Sushi Cards\( Or be Familiar with Javascript and HTML \). If not, Go find them [here](https://www.gitbook.com/@coderdojo).
